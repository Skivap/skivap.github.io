<script lang="ts">
    ...
    function animateToTarget(startPositions:number[], endPositions:Float32Array, duration:number, myflag:number) {
        ...
        if (t < 1 && flag == myflag) {
            requestAnimationFrame(() => animateToTarget(startPositions, endPositions, duration, myflag));
        }
    }
    ...
    function change() { 
        if(flag == 0){
            ...
            animateToTarget(_spherePosition, instaVertices, 10, flag);
        }
        else if(flag == 2){ // Switch to Facebook
            animateToTarget(_spherePosition, facebookVertices, 10, flag);
        }
        else if(flag == 3){ // Switch to Github
            animateToTarget(_spherePosition, githubVertices, 10, flag);
        }
        else if(flag == 4){
            animateToTarget(_spherePosition, originalPosition, 10, flag);
        }
    }
</script>
    ...
    <div class="content">
        <div class="inside-content">
            ...
            <div class="contact">
                ...
                <div class="icon-list">
                    <a class="hover-element" href="https://www.instagram.com/aurickd/" target="_blank"
                    on:mouseover={() => switch_flag(1)} 
                    on:mouseleave={() => switch_flag(4)}>
                    ...
                    <a class="hover-element" href="https://www.facebook.com/AurickD/" target="_blank"
                    ...
                    <a class="hover-element" href="https://github.com/Skivap" target="_blank"
